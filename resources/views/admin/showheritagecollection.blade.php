...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-end">
            <a href="{{ route('admin.heritagecollections.edit', $collection->id) }}" class="btn btn-warning btn-sm">
                <i class="fas fa-edit me-2"></i>Edit
            </a>
            <a href="{{ route('admin.heritagecollections.index') }}" class="btn btn-secondary btn-sm">
