...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 text-end">
            ...
            <a href="{{ route('admin.heritagecollections.create') }}" class="btn btn-primary">
                ...
                <tbody>
                    @forelse($collections as $collection)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.heritagecollections.show', $collection->id) }}" 
                                    class="btn btn-sm btn-info" title="View">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('admin.heritagecollections.edit', $collection->id) }}" 
...
<script>
    function openHistoryModal() {
        ...
        fetch('{{ route("admin.heritagecollections.history") }}')
            .then(r => r.json())
            .then(data => {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (collectionToDelete) {
            fetch(`/admin/heritagecollections/${collectionToDelete}`, {
                method: 'DELETE',
                headers: {
