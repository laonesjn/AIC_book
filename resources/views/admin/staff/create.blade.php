...
<div class="page-header animate-in">
    <div class="page-header-left">
        <h1><i class="bi bi-person-plus-fill me-2" style="color:var(--primary)"></i>Add Staff User</h1>
        <p><i class="bi bi-house"></i> Dashboard / Staff / Create</p>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.staff.store') }}" method="POST">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn-primary-custom">Create Staff</button>
