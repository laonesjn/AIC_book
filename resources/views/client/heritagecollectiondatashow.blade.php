...
<main class="container">
    ...
    <section class="hero-section">
        ...
        <div class="hero-image-container">
             <img src="{{ Str::startsWith($title_img, ['http://','https://']) ? $title_img : asset($title_img) }}" 
        ...
        <div class="hero-content">
            ...
            <div class="collection-metadata">
                <div class="metadata-item">
                    ...
                    <span class="metadata-value">{{ $collection->mainCategory->name }}</span>
                </div>
                <div class="metadata-item">
                    <span class="metadata-label">Subcategory:</span>
                    <span class="metadata-value">{{ $collection->subCategory->name }}</span>
                </div>
                <div class="metadata-item">
                ...
                <div class="image-card">
                    <div class="image-card-image">
                        <img src="{{ Str::startsWith($img, ['http://','https://']) ? $img : asset($img) }}" 
                             alt="{{ $collection->title }} - Image {{ $index + 1 }}" loading="lazy">
                    </div>
...
<!-- <section class="overview-section">
    ...
    <div class="overview-content">
        ...
        <div class="overview-image">
            <img src="{{ Str::startsWith($images[count($images)-1], ['http://','https://']) ? $images[count($images)-1] : asset($images[count($images)-1]) }}" 
                 alt="{{ $collection->title }} - Last Image" loading="lazy">
        </div>
        @endif
    </div>
</section> -->
  ...
  <section class="overview-section">
    ...
    <div class="overview-content">
        ...
        @if($overview_img)
        <div class="overview-image">
            <img src="{{ Str::startsWith($overview_img, ['http://','https://']) ? $overview_img : asset($overview_img) }}" 
                 alt="{{ $collection->title }}" loading="lazy">
        </div>
        @endif
    </div>
    ...
    <div class="pdf-section">
        ...
        @else
            ...
            <button class="pdf-btn" onclick="openPrivateModal(
                '{{ $collection->id }}',
                '{{ addslashes($collection->title) }}',
                '{{ $collection->mainCategory->name }}',
                '{{ $collection->subCategory->name }}',
                '{{ $collection->created_at->format('F d, Y') }}',
                '{{ count($images) > 0 ? (Str::startsWith($images[0], ['http://','https://']) ? $images[0] : asset($images[0])) : '' }}'
            )">
                🔒 Request Access
            </button>
        @endif
      ...
      <div class="request-form-section">
        ...
        <form id="requestAccessForm">
          ...
          <div class="form-group-modal">
            ...
            <input type="tel" id="requestPhone" name="phone" placeholder="Enter your phone number">
            <div class="form-error-msg" id="phoneError">Please enter your phone number</div>
          </div>
