...
<section class="archive-hero text-center mb-5">
    <h1>Archive Centre Collection</h1>
    <p>Explore curated guides on Tamil heritage topics</p>
</section>

{{-- Search + Filter Form --}}
<section class="search-section mb-5">
    <form method="GET" action="{{ route('client.archivecentrecollection') }}" id="filterForm">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 collection-card">
                        <div class="card h-100 border-0 shadow-sm text-center">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                {{-- View Button --}}
                                <a href="{{ route('client.collectionshow', $collection->id) }}"
